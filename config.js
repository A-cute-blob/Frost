module.exports = {
  OWNER_IDS: ["728590937441304586"], // Bot owner ID's
  PREFIX: "!", // Default prefix for the bot
  SUPPORT_SERVER: "https://discord.gg/6GZ9Czt4dX", // Your bot support server
  PRESENCE: {
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "824946991725019197", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  XP_SYSTEM: {
